package crawler.module.news.commands
...
case class RequestSearchNews(sources: Seq[ItemSource.Value], msg: SearchNews)
 ...
 * 搜索结果
  ...
  * @param news 新闻结果
 */
case class SearchPageResult(news: SearchResult)
